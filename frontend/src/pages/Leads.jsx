...
export default function Leads() {
  ...
  const [form, setForm] = useState({ name: '', phone: '', email: '', shop_name: '', address: '', service: 'general', source: 'manual', notes: '' })
  ...
  const createLead = async (e) => {
    ...
    setForm({ name: '', phone: '', email: '', shop_name: '', address: '', service: 'general', source: 'manual', notes: '' })
    setShowForm(false)
    fetchLeads()
  }
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="text-left p-3 text-xs font-medium text-gray-500 uppercase">Address</th>
              ...
              <tbody>
                {leads.map(lead => (
                  <tr key={lead.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="p-3 text-sm text-gray-600 max-w-[200px] truncate">{lead.address || '-'}</td>
                    <td className="p-3">
